...
<html>
<head>
    <title>Tugas Akhir - Biodata</title>
    <style>
...
<body>
    ...
    echo "<h1>BIODATA</h1>";
    echo "<table width='60%'>";
    echo "<tr><td class='atas' width='30%'>Nama :</td><td width='30%'><input type='text' name='name' value='Septo Sugiarto'></td></tr>";
    echo "<tr><td class='atas'>NIM :</td><td><input type='text' name='name' value='2170234025'></td></tr>";
    ...
    echo "</select></td></tr>";
    echo "<tr><td class='atas'>Jenis Kelamin :</td><td><input type='radio' name='jenis_kelamin' value='l' checked>Laki-laki
    <input type='radio' name='jenis_kelamin' value='p'>Perempuan</td></tr>";
    echo "<tr><td class='atas'>E-Mail :</td><td><input type='email' name='email' value='septo.sugiarto.unkris@gmail.com'></td></tr>";
    echo "<tr><td class='atas'>Foto :</td><td><img src='../septo.jpg' width='200px'></img></td></tr>";
